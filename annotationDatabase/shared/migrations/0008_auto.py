...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('shared_annotation', 'value')
        db.rename_column('shared_annotation', 'value_ref_id', 'value_id')

    def backwards(self, orm):
        db.rename_column('shared_annotation', 'value_id', 'value_ref_id')
        db.add_column('shared_annotation', 'value', models.TextField())
