...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AnnotationTemplateEntry.public'
        db.add_column(u'shared_annotationtemplateentry', 'public',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AnnotationTemplateEntry.public'
        db.delete_column(u'shared_annotationtemplateentry', 'public')
